...
const CartPage = () => {
  ...
  if (cartItems.length < 1) {
    return (
      <NotFoundWrapper>
        <div className="container">Корзина пуста!</div>
      </NotFoundWrapper>
    );
  }
        ...
        <div className="cart-grid grid">
          ...
          <div className="cart-grid-left">
            <div className="flex flex-wrap flex-between">
              <div className="cart-count-info">
                <span className="fw-7 fs-18">{total_items}</span> товар(ов) в
                корзине
              </div>
              <button
                type="button"
              ...
              >
                ...
                <span className="d-inline-block text-pink">Удалить все</span>
              </button>
            </div>
          ...
          <div className="cart-grid-right">
            <div className="cart-total">
              <span className="d-block fs-18 fw-6">Всего:</span>
